...
CAT_TO_WORKFLOW = {
    ...
    "AxeIntegrationWLAustralia": ["WL_DNET_Aws_Axe_ANZAU1", "WL_DNET_Axe_ANZAU"],
    "AxeIntegrationWLCANext": ["WL_DNET_Axe_CanadaNext"],
    "AxeIntegrationWLNewZealand": ["WL_DNET_Aws_Axe_ANZNZ1", "WL_DNET_Axe_ANZNZ"],
    "AxeIntegrationWestlawEdgeSearch": ["WL_DNET_Aws_Axe_WL_EdgeSearch1", "WL_DNET_Axe_WL_EdgeSearch"],
    "AxeIntegrationWestlawEdgeWebsite": ["WL_DNET_Aws_Axe_WL_EdgeWebsite1", "WL_DNET_Axe_WL_EdgeWebsite"],
    ...
    "CaseNoteBookAxeIntegartion": ["WL_DNET_Aws_Axe_CaseNoteBook", "WL_DNET_Axe_Test"],
    ...
    "OpenWebAxe": ["WL_DNET_Aws_Axe_OpenWeb", "WL_DNET_Axe_Test1"],
    ...
    "RIandDocumnetAxeIntegration": ["WL_DNET_Aws_Axe_WLNextRIDoc1", "WL_DNET_Axe_WLNextRIDoc"],
    ...
    "TaxnetProAxe": ["WL_DNET_Aws_Axe_TaxnetPro", "WL_DNET_Axe_TaxnetPro"],
    ...
    "WLAnalyticsAxeIntegartion": ["WL_DNET_Aws_Axe_Analytics", "WL_DNET_Axe_Analytics"],
    "WLAnalyticsIndigo": ["WL_DNet_Analytics_Edge"],
    "WLCanadaEdgeAxe": ["WL_DNET_Axe_WLCanadaEdge"],
    "WLEdgeAxeIntegration": ["WL_DNET_Aws_Axe_WL_Edge1", "WL_DNET_Axe_WL_Edge"],
    "WLMobileAxeIntegartion": ["WL_DNET_Aws_Axe_WLNMobile", "WL_DNET_Axe_WLNMobile"],
    "WLNCorrectional": ["WL_DNet_Next_Correctional"],
    "WLNCorrectionalAxeTest": ["WL_DNET_Aws_Axe_Correctional", "WL_DNET_Axe_Correctional"],
    "WLNLinksAxeIntegartion": ["WL_DNET_Aws_Axe_WeslawLinks", "WL_DNET_Axe_WeslawLinks"],
    ...
    "WLPrecisionAxeIntegration": ["WL_DNET_Aws_Axe_WLPrecision", "WL_DNET_Axe_WLPrecision"],
    ...
    "WestlawNextFeatureAxeIntegartion": ["WL_DNET_Aws_Axe_WLNext1", "WL_DNET_Axe_WLNext"],
    "WestlawPatronAxeIntegartion": ["WL_DNET_Aws_Axe_Patron", "WL_DNET_Axe_Patron"],
